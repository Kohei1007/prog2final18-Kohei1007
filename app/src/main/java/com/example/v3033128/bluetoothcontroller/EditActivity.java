...
public class EditActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent,View v, int position, long id){
        ...
        //Toast.makeText(getApplicationContext(), sBefData, Toast.LENGTH_SHORT).show();
    }
                        ...
                        switch (mode){
                            case 0:
                                if(error==0){
                                    ...
                                    //Toast.makeText(getApplicationContext(),String.valueOf(newData.getId())+"f",Toast.LENGTH_SHORT);
                                }
                                break;
                            case 1:
